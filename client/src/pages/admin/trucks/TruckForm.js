...
const TruckForm = () => {
  ...
  useEffect(() => {
    ...
    console.log('📋 Insurance Document:', uploadedFiles.insuranceDocument?.name || 'none');
    console.log('📋 License Requirement:', uploadedFiles.licenseRequirement?.name || 'none');
  }, [uploadedFiles]);
    ...
    try {
      ...
      if (!isEditMode) {
        ...
        if (missingDocs.length > 0) {
          setError(`Please upload all required documents: ${missingDocs.map(doc => 
            doc.replace('Document', '').toUpperCase()).join(', ')}`);
          return;
        }
      }
      ...
      const brandToSave = isOtherBrand && customBrand.trim() ? customBrand.trim() : formData.TruckBrand;
  ...
  return (
    <div className="modern-form-container">
      <div className="modern-form-header">
        ...
        <p>{isEditMode ? 'Update truck information and documents' : 'Register a new truck with required documentation'}</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="modern-form-content">
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">Enter the truck's basic identification and specifications</p>
              </div>
            </div>
            ...
            />
                <div className="form-help-text">Enter the official license plate number</div>
          </div>
            ...
            >
                ...
                <div className="form-help-text">Select the truck classification</div>
          </div>
        </div>

            <div className="form-grid form-grid-3">
              <div className="modern-form-group">
                <label htmlFor="TruckCapacityDisplay" className="modern-form-label">
          ...
          <input
            ...
            disabled
                ...
                />
                <div className="form-help-text">Automatically calculated based on truck type</div>
                <input
                  type="hidden"
                  id="TruckCapacity"
                  name="TruckCapacity"
          ...
          />
            ...
            >
              ...
              <option value="Other">Other (Enter custom brand)</option>
                ...
                <div className="form-help-text">{isOtherBrand ? 'Enter custom brand name below' : 'Select the truck manufacturer'}</div>
          </div>
              ...
              {isOtherBrand && (
                <div className="modern-form-group">
                  <label htmlFor="CustomBrand" className="modern-form-label">
                    Custom Brand Name <span className="required-indicator">*</span>
                  </label>
                  <input
                    type="text"
                    id="CustomBrand"
                    ...
                    maxLength="50"
                  />
                  <div className="form-help-text">Enter the custom truck brand name</div>
                </div>
              )}
            ...
            />
                <div className="form-help-text">Year the truck was manufactured</div>
              </div>
            </div>
          </div>
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">Track truck registration dates and expiry (Annual renewal)</p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              ...
              <div className="modern-form-group">
                ...
                <input
                  ...
                  onChange={handleChange}
                />
                <div className="form-help-text">Date when truck was last registered/renewed</div>
              </div>

              {/* Registration Expiry Date */}
              <div className="modern-form-group">
                <label htmlFor="registrationExpiryDate" className="modern-form-label">
                  Registration Expiry Date <span className="required-indicator">*</span>
                </label>
                <input
                  type="date"
                  ...
                  required
                />
                <div className="form-help-text">When the truck registration expires (annual)</div>
              </div>
            </div>

            {/* Registration Warning Info */}
            <div className="modern-alert modern-alert-warning" style={{ marginTop: '16px' }}>
              <div className="modern-alert-icon">⚠️</div>
              <div className="modern-alert-content">
                <div className="modern-alert-title">Registration Monitoring</div>
                <div>
                  The system will automatically block this truck from allocation and booking when registration 
                  is expiring within 30 days or has expired. The truck cannot be booked if its registration 
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">Configure the truck's operational and allocation status</p>
          </div>
        </div>
            ...
            <div className="form-grid form-grid-2">
              <div className="modern-form-group">
                <label htmlFor="AllocationStatus" className="modern-form-label">
                  Allocation Status <span className="required-indicator">*</span>
                </label>
              <select
                id="AllocationStatus"
              ...
              >
                ...
                <div className="form-help-text">Whether the truck is allocated to a client</div>
            </div>

              <div className="modern-form-group">
                <label htmlFor="OperationalStatus" className="modern-form-label">
                  Operational Status <span className="required-indicator">*</span>
                </label>
              <select
              ...
              >
                ...
                <div className="form-help-text">The operational condition of the truck</div>
            </div>
          </div>

            <div className="form-grid form-grid-2">
              <div className="modern-form-group">
                <label htmlFor="AvailabilityStatus" className="modern-form-label">
                  Availability Status <span className="required-indicator">*</span>
                </label>
              <select
              ...
              >
                ...
                <div className="form-help-text">Current availability for new assignments</div>
            </div>
              ...
              >
                ...
                <div className="form-help-text">Legacy status field for compatibility</div>
            </div>
          </div>
            ...
            <div className="form-grid form-grid-2">
              <div className="modern-form-group">
                ...
                <div className="form-help-text">Check if maintenance is scheduled for this truck</div>
          </div>
            ...
            />
                <div className="form-help-text">Optional explanation for the current status</div>
              </div>
            </div>
          </div>
          ...
          <div className="form-section">
            <div className="form-section-header">
              <div className="form-section-icon">🪪</div>
              <div>
                <h3 className="form-section-title">License Requirements for {formData.TruckType}</h3>
                <p className="form-section-description">Required licenses and personnel for this truck type</p>
          </div>
        </div>
                ...
                <div className="requirements-display">
                  <div className="requirement-item">
                    ...
                    <div className="requirement-content">
                      <strong>Driver License Required:</strong> {requirements.driverLicense}
                    </div>
                  </div>
                  <div className="requirement-item">
                    <div className="requirement-icon">👥</div>
                    <div className="requirement-content">
                      <strong>Number of Helpers Required:</strong> {requirements.helpers}
                    </div>
                  </div>
                  <div className="requirement-item">
                    <div className="requirement-icon">📋</div>
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">
                  All documents are required for new trucks. Please ensure OR/CR documents contain the correct plate number.
                </p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              ...
              <div className="modern-form-group">
                <label htmlFor="orDocument" className="modern-form-label">
                  Original Receipt (OR) <span className="required-indicator">*</span>
                </label>
                ...
                {!uploadedFiles.orDocument && !existingDocuments.orDocument && (
                  <div className="modern-file-upload" onClick={() => document.getElementById('orDocument').click()}>
                    ...
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload OR document</div>
                      <div className="file-upload-secondary">PDF, JPG, PNG up to 25MB</div>
                    </div>
                  </div>
                )}

                {documentErrors.orDocument && (
                  <div className="modern-alert modern-alert-error" style={{ marginTop: '8px' }}>
                    <div className="modern-alert-icon">⚠️</div>
                    <div className="modern-alert-content">{documentErrors.orDocument}</div>
                  </div>
                )}
                ...
                {uploadedFiles.orDocument && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      ...
                      <div className="file-preview-name">{uploadedFiles.orDocument.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                {existingDocuments.orDocument && !uploadedFiles.orDocument && (
                  <div className="existing-file">
                    <div className="existing-file-info">
                      ...
                      <div className="existing-file-name">Current: {existingDocuments.orDocument.originalName}</div>
                    </div>
                ...
                <div className="form-help-text">Upload the Original Receipt document (PDF, JPG, PNG - max 25MB)</div>
              </div>

              {/* Certificate of Registration (CR) */}
              <div className="modern-form-group">
                <label htmlFor="crDocument" className="modern-form-label">
                  Certificate of Registration (CR) <span className="required-indicator">*</span>
                </label>
                ...
                {!uploadedFiles.crDocument && !existingDocuments.crDocument && (
                  <div className="modern-file-upload" onClick={() => document.getElementById('crDocument').click()}>
                    <div className="file-upload-icon">📋</div>
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload CR document</div>
                      <div className="file-upload-secondary">PDF, JPG, PNG up to 25MB</div>
                    </div>
                  </div>
                )}
                ...
                {documentErrors.crDocument && (
                  <div className="modern-alert modern-alert-error" style={{ marginTop: '8px' }}>
                    <div className="modern-alert-icon">⚠️</div>
                    <div className="modern-alert-content">{documentErrors.crDocument}</div>
                  </div>
                )}
                ...
                {uploadedFiles.crDocument && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      <div className="file-preview-icon">📋</div>
                      <div className="file-preview-name">{uploadedFiles.crDocument.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                {existingDocuments.crDocument && !uploadedFiles.crDocument && (
                  <div className="existing-file">
                    <div className="existing-file-info">
                      <div className="existing-file-icon">📋</div>
                      <div className="existing-file-name">Current: {existingDocuments.crDocument.originalName}</div>
                    </div>
                    <div className="existing-file-actions">
                      <button
                        type="button"
                ...
                <div className="form-help-text">Upload Certificate of Registration document (PDF, JPG, PNG - max 25MB)</div>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-1">
              {/* Insurance Document */}
              <div className="modern-form-group">
                <label htmlFor="insuranceDocument" className="modern-form-label">
                ...
                {!uploadedFiles.insuranceDocument && !existingDocuments.insuranceDocument && (
                  <div className="modern-file-upload" onClick={() => document.getElementById('insuranceDocument').click()}>
                    <div className="file-upload-icon">🛡️</div>
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload insurance documents</div>
                      <div className="file-upload-secondary">PDF, JPG, PNG up to 25MB</div>
                    </div>
                  </div>
                )}
                ...
                {documentErrors.insuranceDocument && (
                  <div className="modern-alert modern-alert-error" style={{ marginTop: '8px' }}>
                    <div className="modern-alert-icon">⚠️</div>
                    <div className="modern-alert-content">{documentErrors.insuranceDocument}</div>
                  </div>
                )}
                ...
                {uploadedFiles.insuranceDocument && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      ...
                      <div className="file-preview-name">{uploadedFiles.insuranceDocument.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                {existingDocuments.insuranceDocument && !uploadedFiles.insuranceDocument && (
                  <div className="existing-file">
                    <div className="existing-file-info">
                      ...
                      <div className="existing-file-name">Current: {existingDocuments.insuranceDocument.originalName}</div>
                    </div>
                    <div className="existing-file-actions">
                      <button
                        type="button"
                        onClick={() => handleViewDocument('insuranceDocument')}
                        className="file-view-btn"
                      >
                        View
                      </button>
                      <button
                        type="button"
                        onClick={() => handleReplaceDocument('insuranceDocument')}
                        className="file-replace-btn"
                      >
                        Replace
                      </button>
                ...
                <div className="form-help-text">Upload insurance documents (PDF, JPG, PNG - max 25MB)</div>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-1">
              ...
              <div className="modern-form-group">
                <label htmlFor="licenseRequirement" className="modern-form-label">
                  License Requirement Document (Optional)
                </label>
                ...
                {!uploadedFiles.licenseRequirement && !existingDocuments.licenseRequirement && (
                  <div className="modern-file-upload" onClick={() => document.getElementById('licenseRequirement').click()}>
                    <div className="file-upload-icon">📜</div>
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload license requirements</div>
                      <div className="file-upload-secondary">PDF, JPG, PNG up to 25MB</div>
                    </div>
                  </div>
                )}
                ...
                {documentErrors.licenseRequirement && (
                  <div className="modern-alert modern-alert-error" style={{ marginTop: '8px' }}>
                    <div className="modern-alert-icon">⚠️</div>
                    <div className="modern-alert-content">{documentErrors.licenseRequirement}</div>
                  </div>
                )}
                ...
                {uploadedFiles.licenseRequirement && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      <div className="file-preview-icon">📜</div>
                      <div className="file-preview-name">{uploadedFiles.licenseRequirement.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                {existingDocuments.licenseRequirement && !uploadedFiles.licenseRequirement && (
                  <div className="existing-file">
                    <div className="existing-file-info">
                      <div className="existing-file-icon">📜</div>
                      <div className="existing-file-name">Current: {existingDocuments.licenseRequirement.originalName}</div>
                    </div>
                    <button
                      type="button"
                ...
                <div className="form-help-text">Optional: Upload specific license requirements for this truck (PDF, JPG, PNG - max 25MB)</div>
              </div>
            </div>
          </div>

          {/* Display existing documents */}
          {isEditMode && Object.keys(existingDocuments).length > 0 && (
            <FileViewer 
