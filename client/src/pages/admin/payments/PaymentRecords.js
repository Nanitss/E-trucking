  ...
  useEffect(() => {
    ...
    if (searchTerm) {
      filtered = filtered.filter(payment => 
        payment.deliveryId?.toLowerCase().includes(searchTerm.toLowerCase()) ||
    ...
    <div className="admin-page-container">
      ...
      <div className="admin-content">
        ...
        <div className="greeting-section">
          ...
          <p className="greeting-subtitle">Track and manage payment transactions and financial records</p>
          ...
          <div className="summary-cards">
            ...
            <div className="summary-card">
              ...
              <div className="card-content">
                <div className="card-value">{payments.filter(p => p.status === 'completed').length}</div>
            ...
            <div className="summary-card">
              ...
              <div className="card-content">
                <div className="card-value">{payments.filter(p => p.status === 'pending').length}</div>
            ...
            <div className="summary-card">
              ...
              <div className="card-content">
                <div className="card-value">{payments.filter(p => p.status === 'failed').length}</div>
                ...
                <tr key={payment.id}>
                  ...
                  <td>
                    <span className="payment-method">
                      {payment.metadata?.paymentMethod || payment.paymentMethod || 'N/A'}
                    </span>
                  </td>
                  <td>
                  ...
                  <td>
                    <div className="actions">
                      <Link to={`/admin/payments/${payment.id}`} className="btn btn-sm btn-view">
                        View
                      </Link>
                    </div>
                  </td>
      ...
      <div className="table-footer">
        <p>Showing {filteredPayments.length} of {payments.length} payment records</p>
      </div>
      </div>
    </div>
  );
