  ...
  useEffect(() => {
    const fetchDriver = async () => {
      ...
      try {
        ...
        const response = await axios.get(`${baseURL}/api/admin/drivers/${id}`, config);
        ...
        setFormData({
          ...
          licenseRegistrationDate: formatDateSafely(driver.licenseRegistrationDate),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!isEditMode) {
        ...
        if (missingDocs.length > 0) {
          setError(`Please upload all required documents: ${missingDocs.map(doc => 
            doc.replace('Document', '').replace('Certificate', '').toUpperCase()).join(', ')}`);
          return;
        }
      }
      ...
      if (isEditMode) {
        ...
        console.log('📤 New uploaded files:', Object.keys(uploadedFiles).filter(k => uploadedFiles[k]));
        ...
        Object.entries(originalDocuments).forEach(([docType, docData]) => {
          ...
          if (!uploadedFiles[docType] && docData) {
            console.log(`📄 Preserving existing document: ${docType}`, docData.filename);
  ...
  return (
    <div className="modern-form-container">
      <div className="modern-form-header">
        ...
        <p>{isEditMode ? 'Update driver information and documents' : 'Register a new driver with required documentation'}</p>
      </div>
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">Enter the driver's personal and contact information</p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              <div className="modern-form-group">
                ...
                />
                <div className="form-help-text">Enter the driver's complete legal name</div>
              </div>
              ...
              <div className="modern-form-group">
                ...
                />
                <div className="form-help-text">Primary contact number for the driver</div>
              </div>
            </div>
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">Employment details and current status</p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-3">
              ...
              <div className="modern-form-group">
                <label htmlFor="DriverEmploymentDate" className="modern-form-label">
                ...
                <input
                  ...
                  required
                />
                <div className="form-help-text">Date when the driver was hired</div>
              </div>
              ...
              <div className="modern-form-group">
                ...
                />
                <div className="form-help-text">Optional notes about driver documents</div>
                        </div>
        </div>
      </div>
      ...
      <div className="form-section">
        ...
        <div className="form-grid form-grid-2">
          ...
          <div className="modern-form-group">
            ...
            />
            <div className="form-help-text">Driver's license number (optional)</div>
          </div>
        </div>
        ...
        <div className="form-grid form-grid-2">
          ...
          <div className="modern-form-group">
            <label htmlFor="licenseRegistrationDate" className="modern-form-label">
              License Registration Date
            </label>
            <input
              type="date"
              ...
              onChange={handleChange}
            />
            <div className="form-help-text">Date when license was last renewed</div>
          </div>

          {/* License Expiry Date */}
          <div className="modern-form-group">
            <label htmlFor="licenseExpiryDate" className="modern-form-label">
              License Expiry Date
            </label>
            <input
              type="date"
              ...
              onChange={handleChange}
            />
            <div className="form-help-text">When the license expires (optional)</div>
          </div>
        </div>

        {/* License Type Information */}
        <div className="modern-alert modern-alert-info" style={{ marginTop: '16px' }}>
          <div className="modern-alert-icon">ℹ️</div>
          <div className="modern-alert-content">
            <div className="modern-alert-title">License Type Details</div>
            <div>
              <strong>Class C:</strong> Can drive mini trucks and light vehicles only<br/>
              <strong>Class CE:</strong> Can drive all truck types including 4-wheeler, 6-wheeler, 8-wheeler, and 10-wheeler trucks
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="form-section">
        <div className="form-section-header">
          ...
          <div>
            ...
            <p className="form-section-description">Contact person in case of emergency</p>
          </div>
        </div>
        ...
        <div className="form-grid form-grid-3">
          ...
          <div className="modern-form-group">
            <label htmlFor="emergencyContactName" className="modern-form-label">
              Emergency Contact Name
            </label>
            <input
              type="text"
            ...
            />
            <div className="form-help-text">Full name of emergency contact</div>
          </div>

          {/* Emergency Contact Phone */}
          <div className="modern-form-group">
            <label htmlFor="emergencyContactPhone" className="modern-form-label">
              Emergency Contact Phone
            </label>
            <input
              type="text"
          ...
          <div className="modern-form-group">
            <label htmlFor="emergencyContactRelationship" className="modern-form-label">
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">Login credentials for the driver portal</p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              ...
              {!isEditMode && (
                <div className="modern-form-group">
                  ...
                  />
                  <div className="form-help-text">Secure password for driver login</div>
                </div>
              )}
              ...
              {isEditMode && (
                <div className="modern-form-group">
                  ...
                  <div className="modern-alert modern-alert-info" style={{ margin: 0 }}>
                    <div className="modern-alert-icon">🔒</div>
                    <div className="modern-alert-content">
                      <div>Password cannot be changed by admin. Driver must change their own password through their account settings.</div>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">
                  All documents are required for new drivers. Please upload clear, readable copies.
                </p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              ...
              <div className="modern-form-group">
                ...
                {!uploadedFiles.licenseDocument && !existingDocuments.licenseDocument && (
                  <div className="modern-file-upload">
                    ...
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload driver's license</div>
                ...
                {documentErrors.licenseDocument && (
                  <div className="modern-alert modern-alert-error" style={{ marginTop: '8px' }}>
                    <div className="modern-alert-icon">⚠️</div>
                    <div className="modern-alert-content">{documentErrors.licenseDocument}</div>
                  </div>
                )}
                ...
                {uploadedFiles.licenseDocument && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      ...
                      <div className="file-preview-name">{uploadedFiles.licenseDocument.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                <div className="form-help-text">Upload driver's license (PDF, JPG, PNG - max 25MB)</div>
              </div>

              {/* Medical Certificate */}
              <div className="modern-form-group">
                <label htmlFor="medicalCertificate" className="modern-form-label">
                  Medical Certificate <span className="required-indicator">*</span>
                </label>
                
                {!uploadedFiles.medicalCertificate && !existingDocuments.medicalCertificate && (
                  <div className="modern-file-upload">
                    <input
                      type="file"
                    ...
                    <div className="file-upload-icon">🏥</div>
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload medical certificate</div>
                      <div className="file-upload-secondary">PDF, JPG, PNG up to 25MB</div>
                    </div>
                  </div>
                )}
                ...
                {documentErrors.medicalCertificate && (
                  <div className="modern-alert modern-alert-error" style={{ marginTop: '8px' }}>
                    <div className="modern-alert-icon">⚠️</div>
                    <div className="modern-alert-content">{documentErrors.medicalCertificate}</div>
                  </div>
                )}
                ...
                {uploadedFiles.medicalCertificate && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      <div className="file-preview-icon">🏥</div>
                      <div className="file-preview-name">{uploadedFiles.medicalCertificate.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                {existingDocuments.medicalCertificate && !uploadedFiles.medicalCertificate && (
                  <div className="existing-file">
                    <div className="existing-file-info">
                      <div className="existing-file-icon">🏥</div>
                      <div className="existing-file-name">Current: {existingDocuments.medicalCertificate.originalName}</div>
                    </div>
                    <div className="existing-file-actions">
                      <button
                        type="button"
                        onClick={() => handleViewDocument('medicalCertificate')}
                        className="file-view-btn"
                      >
                        View
                      </button>
                      <button
                        type="button"
                        onClick={() => handleReplaceDocument('medicalCertificate')}
                        className="file-replace-btn"
                      >
                        Replace
                      </button>
                ...
                <div className="form-help-text">Upload medical certificate (PDF, JPG, PNG - max 25MB)</div>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              ...
              <div className="modern-form-group">
                ...
                {!uploadedFiles.idPhoto && !existingDocuments.idPhoto && (
                  <div className="modern-file-upload">
                    ...
                    <div className="file-upload-icon">📷</div>
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload ID photo</div>
                      <div className="file-upload-secondary">JPG, PNG up to 25MB</div>
                    </div>
                  </div>
                )}
                ...
                {documentErrors.idPhoto && (
                  <div className="modern-alert modern-alert-error" style={{ marginTop: '8px' }}>
                    <div className="modern-alert-icon">⚠️</div>
                    <div className="modern-alert-content">{documentErrors.idPhoto}</div>
                  </div>
                )}
                ...
                {uploadedFiles.idPhoto && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      <div className="file-preview-icon">📷</div>
                      <div className="file-preview-name">{uploadedFiles.idPhoto.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                {existingDocuments.idPhoto && !uploadedFiles.idPhoto && (
                  <div className="existing-file">
                    <div className="existing-file-info">
                      <div className="existing-file-icon">📷</div>
                      <div className="existing-file-name">Current: {existingDocuments.idPhoto.originalName}</div>
                    </div>
                    <div className="existing-file-actions">
                      <button
                        type="button"
                ...
                <div className="form-help-text">Upload clear ID photo (JPG, PNG - max 25MB)</div>
              </div>
              ...
              <div className="modern-form-group">
                ...
                {!uploadedFiles.nbiClearance && !existingDocuments.nbiClearance && (
                  <div className="modern-file-upload">
                    <input
                      type="file"
                      id="nbiClearance"
                    ...
                    <div className="file-upload-icon">📋</div>
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload NBI clearance</div>
                      <div className="file-upload-secondary">PDF, JPG, PNG up to 25MB</div>
                    </div>
                  </div>
                )}
                ...
                {documentErrors.nbiClearance && (
                  <div className="modern-alert modern-alert-error" style={{ marginTop: '8px' }}>
                    <div className="modern-alert-icon">⚠️</div>
                    <div className="modern-alert-content">{documentErrors.nbiClearance}</div>
                  </div>
                )}
                ...
                {uploadedFiles.nbiClearance && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      <div className="file-preview-icon">📋</div>
                      <div className="file-preview-name">{uploadedFiles.nbiClearance.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                {existingDocuments.nbiClearance && !uploadedFiles.nbiClearance && (
                  <div className="existing-file">
                    <div className="existing-file-info">
                      <div className="existing-file-icon">📋</div>
                      <div className="existing-file-name">Current: {existingDocuments.nbiClearance.originalName}</div>
                    </div>
                    <div className="existing-file-actions">
                      <button
                        type="button"
                ...
                <div className="form-help-text">Optional: Upload NBI clearance (PDF, JPG, PNG - max 25MB)</div>
              </div>
            </div>
          </div>
            ...
            <div className="modal-body" style={{ textAlign: 'center', padding: '20px' }}>
              <img 
                ...
                onError={(e) => {
                  ...
                  e.target.parentElement.innerHTML += '<p style="color: red;">Failed to load image. Please check the file exists.</p>';
                }}
              />
            </div>
          </div>
