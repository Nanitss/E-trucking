      ...
      <div className="modern-form-header">
        ...
        <p>
          {isEditMode
            ...
            : "Register a new staff member with department details"}
        </p>
      </div>
            ...
            <div className="form-grid form-grid-2">
              <div className="modern-form-group">
                ...
                <div className="form-help-text">
                  Enter the staff member's complete legal name
                </div>
              </div>
              ...
              <div className="modern-form-group">
                ...
                />
                <div className="form-help-text">
                  Primary contact number for the staff member
                </div>
              </div>
            </div>
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">
                  Department assignment and employment details
                </p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-3">
              <div className="modern-form-group">
                ...
                />
                <div className="form-help-text">
                  Department or division assignment
                </div>
              </div>

              <div className="modern-form-group">
                <label
                  htmlFor="StaffEmploymentDate"
            ...
            <div className="form-grid form-grid-1">
              <div className="modern-form-group">
                ...
                />
                <div className="form-help-text">
                  Optional notes about staff documents
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">
                  Login credentials for the staff portal
                </p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              ...
              <div className="modern-form-group">
                ...
                <div className="form-help-text">
                  {isEditMode
                    ? "Leave blank to keep current password"
                    : "Secure password for staff portal access"}
                </div>
              </div>
            </div>
          </div>
