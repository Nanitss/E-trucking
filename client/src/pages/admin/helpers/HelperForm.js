    ...
    const fetchHelper = async () => {
      ...
      try {
        ...
        setFormData({
          ...
          dateHired: helper.dateHired || helper.HelperEmploymentDate 
            ? new Date(helper.dateHired || helper.HelperEmploymentDate).toISOString().split('T')[0]
            : '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        await axios.put(`${baseURL}/api/admin/helpers/${id}`, formDataToSend, config);
        setSuccessMessage('Helper updated successfully!');
      } else {
        // Create new helper
        console.log('Creating new helper...');
        const response = await axios.post(`${baseURL}/api/admin/helpers`, formDataToSend, config);
  ...
  return (
    <div className="modern-form-container">
      <div className="modern-form-header">
        ...
        <p>{isEditMode ? 'Update helper information and documents' : 'Register a new helper with required documentation'}</p>
      </div>
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">Enter the helper's personal and contact information</p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              <div className="modern-form-group">
                ...
                />
                <div className="form-help-text">Enter the helper's complete legal name</div>
              </div>
              ...
              <div className="modern-form-group">
                ...
                />
                <div className="form-help-text">Primary contact number for the helper</div>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              <div className="modern-form-group">
                ...
                />
                <div className="form-help-text">Name of emergency contact person</div>
              </div>

              <div className="modern-form-group">
                <label htmlFor="emergencyContactNumber" className="modern-form-label">
                ...
                />
                <div className="form-help-text">Phone number of emergency contact</div>
              </div>
            </div>
          </div>
            ...
            <div className="form-grid form-grid-2">
              <div className="modern-form-group">
                ...
                <input
                  ...
                  required
                />
                <div className="form-help-text">Date when the helper was hired</div>
              </div>
          ...
          <div className="form-section">
            ...
            <div className="form-grid form-grid-3">
              ...
              <div className="modern-form-group">
                ...
                />
                <div className="form-help-text">Helper's license number (optional)</div>
              </div>
            ...
            <div className="modern-alert modern-alert-info" style={{ marginTop: '16px' }}>
              ...
              <div className="modern-alert-content">
                ...
                <div>
                  <strong>Class C:</strong> Can assist with mini trucks and light vehicles only<br/>
                  <strong>Class CE:</strong> Can assist with all truck types including heavy vehicles
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">Login credentials for the helper portal</p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              ...
              {!isEditMode && (
                <div className="modern-form-group">
                  ...
                  />
                  <div className="form-help-text">Secure password for helper login</div>
                </div>
              )}
              ...
              {isEditMode && (
                <div className="modern-form-group">
                  ...
                  <div className="modern-alert modern-alert-info" style={{ margin: 0 }}>
                    <div className="modern-alert-icon">🔒</div>
                    <div className="modern-alert-content">
                      <div>Password cannot be changed by admin. Helper must change their own password through their account settings.</div>
                    </div>
                  </div>
                </div>
              )}
          ...
          <div className="form-section">
            <div className="form-section-header">
              ...
              <div>
                ...
                <p className="form-section-description">
                  All documents are required for new helpers. Please upload clear, readable copies.
                </p>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              ...
              <div className="modern-form-group">
                ...
                {!uploadedFiles.validId && !existingDocuments.validId && (
                  <div className="modern-file-upload">
                    ...
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload valid ID</div>
                ...
                {uploadedFiles.validId && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      ...
                      <div className="file-preview-name">{uploadedFiles.validId.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                <div className="form-help-text">Upload valid government-issued ID (PDF, JPG, PNG - max 25MB)</div>
              </div>

              {/* Barangay Clearance */}
              <div className="modern-form-group">
                <label htmlFor="barangayClearance" className="modern-form-label">
                  Barangay Clearance <span className="required-indicator">*</span>
                </label>
                
                {!uploadedFiles.barangayClearance && !existingDocuments.barangayClearance && (
                  <div className="modern-file-upload">
                    <input
                      type="file"
                    ...
                    <div className="file-upload-icon">📋</div>
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload barangay clearance</div>
                      <div className="file-upload-secondary">PDF, JPG, PNG up to 25MB</div>
                    </div>
                  </div>
                )}
                ...
                {uploadedFiles.barangayClearance && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      <div className="file-preview-icon">📋</div>
                      <div className="file-preview-name">{uploadedFiles.barangayClearance.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                {existingDocuments.barangayClearance && !uploadedFiles.barangayClearance && (
                  <div className="existing-file">
                    <div className="existing-file-info">
                      <div className="existing-file-icon">📄</div>
                      <div className="existing-file-name">Current: {existingDocuments.barangayClearance.originalName}</div>
                    </div>
                    <div className="existing-file-actions">
                      <button
                        type="button"
                        onClick={() => handleViewDocument('barangayClearance')}
                        className="file-view-btn"
                      >
                        View
                      </button>
                      <button
                        type="button"
                        onClick={() => handleReplaceDocument('barangayClearance')}
                        className="file-replace-btn"
                      >
                        Replace
                      </button>
                ...
                <div className="form-help-text">Upload barangay clearance certificate (PDF, JPG, PNG - max 25MB)</div>
              </div>
            </div>
            ...
            <div className="form-grid form-grid-2">
              ...
              <div className="modern-form-group">
                ...
                <div className="form-help-text">Optional: Upload medical fitness certificate (PDF, JPG, PNG - max 25MB)</div>
              </div>
              ...
              <div className="modern-form-group">
                ...
                {!uploadedFiles.helperLicense && !existingDocuments.helperLicense && (
                  <div className="modern-file-upload">
                    <input
                      type="file"
                      id="helperLicense"
                    ...
                    <div className="file-upload-icon">📜</div>
                    <div className="file-upload-text">
                      <div className="file-upload-primary">Click to upload helper license</div>
                      <div className="file-upload-secondary">PDF, JPG, PNG up to 25MB</div>
                    </div>
                  </div>
                )}
                ...
                {uploadedFiles.helperLicense && (
                  <div className="file-preview">
                    <div className="file-preview-info">
                      <div className="file-preview-icon">📜</div>
                      <div className="file-preview-name">{uploadedFiles.helperLicense.name}</div>
                    </div>
                    <button
                      type="button"
                ...
                {existingDocuments.helperLicense && !uploadedFiles.helperLicense && (
                  <div className="existing-file">
                    <div className="existing-file-info">
                      <div className="existing-file-icon">📜</div>
                      <div className="existing-file-name">Current: {existingDocuments.helperLicense.originalName}</div>
                    </div>
                    <div className="existing-file-actions">
                      <button
                        type="button"
                ...
                <div className="form-help-text">Optional: Upload helper license if applicable (PDF, JPG, PNG - max 25MB)</div>
              </div>
            </div>
          </div>
