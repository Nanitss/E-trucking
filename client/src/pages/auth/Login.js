...
const Login = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      if (!login) {
        console.log('AuthContext login function not available, using direct axios call');
        ...
        const userRes = await axios.get('http://localhost:5007/api/auth/current-user', {
          headers: {
    ...
    <div className="auth-container">
      ...
      <div className="auth-hero">
        ...
        <div className="hero-logo">
          ...
          <div>
            <div className="logo-text">TruckManager</div>
        ...
        <div className="hero-content">
          <h1 className="hero-title">
            Manage Your <span className="highlight">Fleet</span><br />
      ...
      <div className="auth-form-container">
        ...
        <div className="auth-card">
          <div className="auth-header">
            <h2>Welcome Back</h2>
            <p>Sign in to your trucking dashboard</p>
          </div>
