      ...
      <ModernToastProvider>
        <TimeframeProvider>
          <GlobalNotificationProvider>
            ...
            <ProtectedRoute path="/client/landing" component={ClientLanding} />
            ...
            <ProtectedRoute path="/client/payment-management" component={PaymentManagement} />

            {/* Payment Dashboard Route */}
            <ProtectedRoute path="/admin/payments/payments-dashboard" component={PaymentsDashboard} />

            {/* File Upload Test */}
            <Route path="/upload-test" component={SimpleFileUpload} />
            <Route path="/enhanced-upload-test" component={FileUploadTest} />
